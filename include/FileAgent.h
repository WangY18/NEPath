...
public:
    ...
    static vector<string> get_AllFiles(char const *path, bool folder = false, char const *filename_pre = NULL, char const *filename_post = NULL); // get all filenames in the folder
