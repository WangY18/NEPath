...
class OptimizationAlgorithm(Enum):
    """Optimization solver for non-equidistant toolpath generation."""
...
class Curve:
    ...
    @staticmethod
    def wash_dis(p: Path, dis: float, num_least: int) -> Path:
        """
        Resample the path with a distance approximately equal to dis,
        where the minimum number of waypoints is num_least
        """
        ...
