...
resolved, so acceptable termination is permitted at $10^{-3}$ only after
five consecutive acceptable iterations and with objective change below
$10^{-8}$. The acceptable primal-constraint violation remains $10^{-7}$.
Gurobi objective and geometry parity are the downstream correctness gates for
an acceptable-level solution.
...
Each convex subproblem is capped at 500 Ipopt iterations and 240 seconds wall
