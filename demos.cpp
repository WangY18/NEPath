...
void demo_CP_CFS() {
	...
	FileAgent::delete_AllFiles(R"(.\data_examples\demo_CP_CFS\)");
	FileAgent::write_csv(CP_paths, R"(.\data_examples\demo_CP_CFS\)", ".csv");
	// FileAgent::write_csv(contour, R"(.\data_examples\contour.csv)");
}
...
void demo_CP_DFS() {
	...
	FileAgent::delete_AllFiles(R"(.\data_examples\demo_CP_DFS\)");
	FileAgent::write_csv(CP_paths, R"(.\data_examples\demo_CP_DFS\)", ".csv");
	// FileAgent::write_csv(contour, R"(.\data_examples\contour.csv)");
}
...
void demo_IQOP_CFS() {
	...
	FileAgent::delete_AllFiles(R"(.\data_examples\demo_IQOP\path_IQOP_CFS\)");
	FileAgent::write_csv(IQOP_paths, R"(.\data_examples\demo_IQOP\path_IQOP_CFS\)", ".csv");
	// FileAgent::write_csv(contour, R"(.\data_examples\demo_IQOP\contour.csv)");
}
...
void demo_IQOP_DFS() {
	...
	FileAgent::delete_AllFiles(R"(.\data_examples\demo_IQOP\path_IQOP_DFS\)");
	FileAgent::write_csv(IQOP_paths, R"(.\data_examples\demo_IQOP\path_IQOP_DFS\)", ".csv");
	// FileAgent::write_csv(contour, R"(.\data_examples\demo_IQOP\contour.csv)");
}
#endif